...
public class UserAccountRepoProxy implements CrudRepository<Integer, UserAccount>{
    ...
    public List<Stats> getAllStats(){
        List<Stats> all = new ArrayList<>(Arrays.asList(new Stats(1,7.12,"120/70",120,78.1),new Stats(1,7.12,"120/70",120,78.1),
                new Stats(1,3.21,"110/80",100,78.3),new Stats(1,4.19,"100/60",112,78.0),new Stats(1,9.1,"120/70",110,78.2),
                new Stats(1,2.6,"110/70",90,78.3),new Stats(1,7.14,"90/70",98,78.4),new Stats(2,7.12,"120/70",120,90.0),
                new Stats(1,4.12,"100/67",114,78.41),new Stats(1,4.19,"100/50",93,78.1),new Stats(2,5.4,"110/70",110,90.1),new Stats(2,6.16,"110/80",110,90.2),
                new Stats(2,8.99,"125/80",120,89.9),new Stats(3,7.12,"120/70",90,57.1),new Stats(3,3.12,"130/90",115,59.1)));
